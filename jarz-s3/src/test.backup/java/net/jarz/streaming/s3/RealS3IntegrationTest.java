...
class RealS3IntegrationTest {
    ...
    private static class RealS3TestHelper {
        ...
        public String createAndUploadTestJarz(int numClasses) throws Exception {
            ...
            try (net.jarz.streaming.v2.BlockWriter writer = new net.jarz.streaming.v2.BlockWriter(tempJarz)) {
                net.jarz.streaming.v2.Block block = new net.jarz.streaming.v2.Block(0);
