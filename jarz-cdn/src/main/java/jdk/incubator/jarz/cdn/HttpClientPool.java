...
final class HttpClientPool {
     ...
     */
    static final class HttpClientConfig {
        private final Duration connectTimeout;
        
        HttpClientConfig(Duration connectTimeout) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof HttpClientConfig)) return false;
            HttpClientConfig other = (HttpClientConfig) obj;
            return java.util.Objects.equals(connectTimeout, other.connectTimeout);
        }
        
        @Override
        public int hashCode() {
            return java.util.Objects.hash(connectTimeout);
        }
        
        @Override
        public String toString() {
            return "HttpClientConfig[connectTimeout=" + connectTimeout + "]";
        }
    }
}
