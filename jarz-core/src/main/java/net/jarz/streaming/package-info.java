 ...
 * <ul>
 *   <li>{@code net.jarz.streaming.classloader} - ClassLoader implementations</li>
 *   <li>{@code net.jarz.streaming.v2} - JARZ v2 format implementation</li>
 * </ul>
 * 
 * @since 1.0
 */
package net.jarz.streaming;
